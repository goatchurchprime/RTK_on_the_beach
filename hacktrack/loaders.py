...
def linfuncZ(line):
    ...
    s = int(line[61:63], 16)
    if len(line)>=78:
        mx, my, mz = s16(line[64:68])/900.0, s16(line[69:73])/900.0, s16(line[74:78])/900.0 # gyros (new) 
    else:
        mx, my, mz = 0,0,0
    ...
    #    raise ValueError()
    return (t, ax, ay, az, gx, gy, gz, q0, q1, q2, q3, s, mx, my, mz)
...
recargsY = ('Y', linfuncZ, ["ax", "ay", "az", "gx", "gy", "gz", "q0", "q1", "q2", "q3", "s", "mx", "my", "mz"]) 
